...
import { ImageList, ImageListItem, Box, Typography, Button, MenuItem, Select } from '@mui/material';
        ...
        <ImageList cols={4} gap={20}>
          {products.map((product) => (
            ...
            >
              ...
              />
              <Box sx={{ padding: 2, flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
                <Box sx={{ flexGrow: 1 }}>
                  ...
                  <Select
                    ...
                    onChange={(e) => setColor({ ...color, [product._id]: e.target.value as string })}
                    displayEmpty
                    fullWidth
                    sx={{ mt: 1, mb: 1 }}
                  >
                  ...
                  <Select
                    ...
                    onChange={(e) => setSize({ ...size, [product._id]: e.target.value as string })}
                    displayEmpty
                    fullWidth
                    sx={{ mb: 1 }}
                  >
                ...
                <Button variant="contained" color="primary" onClick={() => handleAddToCart(product)} sx={{ mt: 1 }}>
                  Add to Cart
                </Button>
              </Box>
            </ImageListItem>
